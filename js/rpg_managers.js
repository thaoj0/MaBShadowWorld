...
StorageManager.localFilePath = function(savefileId) {
    var name;
    if (savefileId < 0) {
        name = 'config.mabshadow';
    } else if (savefileId === 0) {
        name = 'global.mabshadow';
    } else {
        name = 'save%1.mabshadow'.format(savefileId);
    }
...
StorageManager.webStorageKey = function(savefileId) {
    if (savefileId < 0) {
        return 'mabshadow Config';
    } else if (savefileId === 0) {
        return 'mabshadow Global';
    } else {
        return 'mabshadow Save%1'.format(savefileId);
    }
};
